...
class Mediator {
  ...
  updateStats(objectRules, X, O, draw) {
    ...
    objectRules.round++;
    this.updateData.addTableStatistics(objectRules.round, X.winData, O.winData, draw);
    this.restart.restartAllBackData(this.rules.gameRounds, this.rules, X, O, this.D);
    if (winnerBanner.style.top === '50%') {
